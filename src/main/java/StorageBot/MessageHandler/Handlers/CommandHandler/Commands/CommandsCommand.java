...
public class CommandsCommand implements Command_I
{
    public Object execute(String[] args)
    {
        return "Вот список команд для бота:\n" +
                "\t'/mkstg stgId' - Создать хранилище с id 'stgId'.\n" +
                "\t'/chstg stgId' - Перейти в хранилище с id 'stgId'.\n" +
                "\t'/getStgId' - Узнать Id текущего хранилища.\n" +
                ...
                "\tЕсли вы хотите отправить видео без сжатия, укажите в подписи имя, под которым вы хотите сохранить видео.\n" +
                "\t(Если вы этого не сделаете, файл будет сохранён под системным именем).\n" +
                "\t(К великому сожалению разработчиков, на данном этапе максимальный размер файла, который может принимать бот, составляет 20 МБ).\n" +
